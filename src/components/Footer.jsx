    ...
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
            ...
            <div className="">
                ...
                <p className="mb-4">
                    <a className="text-neutral-600 dark:text-neutral-200">Most views</a>
                </p>
                <p className="mb-4">
                <a className="text-neutral-600 dark:text-neutral-200">Oferts</a>
                </p>
                <p className="mb-4">
                <a className="text-neutral-600 dark:text-neutral-200">Arrive today</a>
                </p>
                <p>
                <a className="text-neutral-600 dark:text-neutral-200">Descounts</a>
                </p>
            </div>
