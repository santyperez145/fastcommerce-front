  ...
  return (
    <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div className="flex justify-center">
          ...
          <a className="mr-6 text-neutral-600 dark:text-neutral-200">
            <svg xmlns="http://www.w3.org/2000/svg"bclassName="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
            ...
            <div className="">
                ...
                <p className="mb-4">
                    <a className="text-neutral-600 dark:text-neutral-200">All products</a>
                </p>
                <p className="mb-4">
                <a className="text-neutral-600 dark:text-neutral-200">Carpentry</a>
                </p>
                <p className="mb-4">
                <a className="text-neutral-600 dark:text-neutral-200">Hardware</a>
                </p>
                <p>
                <a className="text-neutral-600 dark:text-neutral-200">Electrical</a>
                </p>
            </div>
          ...
          <div className="">
            ...
            <p className="mb-4">
              <a className="text-neutral-600 dark:text-neutral-200">Categories</a>
            </p>
            <p>
          ...
          {/* <!-- Contact section --> */}
          <div>
            <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">Contact
            </h6>
      ...
      <div className="bg-neutral-200 p-6 text-center dark:bg-neutral-700">
        ...
        <a className="font-semibold text-neutral-600 dark:text-neutral-400" href="localhost:5173/"> FastCommerce</a>
      </div>
    </footer>
  );
}