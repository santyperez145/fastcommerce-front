    ...
    return (
      <>
        <div className="flex w- h-screen items-center justify-center bg-gray-300">
          ...
          <p className="text-[#1F1F1F] text-center text-[32px] not-italic font-bold leading-[normal] tracking-[1.6px]">Welcome to <span className="flex text-purple-600">FastCommerce!</span> </p>
            ...
            <form onSubmit={handleFormSubmit} method="POST" className="w-full">
              ...
              <div>
                <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] font-normal leading-[normal] tracking-[0.6px] text-xs text-purple-600">Name</p>
                ...
                <div>
                <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] font-normal leading-[normal] tracking-[0.6px] text-xs text-purple-600">Email</p>
                ...
                <div>
                  <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] font-normal leading-[normal] tracking-[0.6px] text-xs text-purple-600">Photo</p>
                ...
                <div>
                  <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] leading-[normal] tracking-[0.6px] text-xs text-purple-600">Password</p>
                ...
                <div className="flex w-[70vw] md:w-[30vw] h-12 flex-col justify-center shrink-0 bg-purple-600 rounded-[10px]">
                ...
                <div className="w-[70vw] md:w-[30vw] h-12 shrink-0 border rounded-[10px] border-solid border-purple-600 flex justify-center items-center">
                ...
                <p className="text-[#1F1F1F] text-[21px] not-italic font-medium leading-[normal] tracking-[0.7px]">Already have an account? <Anchor to={'/login'} className="text-purple-600">Log in</Anchor></p>
                <p className="text-[#1F1F1F] text-[21px] not-italic font-medium leading-[normal] tracking-[0.7px]">Go back to <Anchor to={'/'} className="text-purple-600">home page</Anchor></p>
              </div>
            </form>
          </div>
        </div>
