        ...
        <div className="flex w- h-screen items-center justify-center bg-gray-200">
          ...
          <p className="text-[#1F1F1F] text-center text-[32px] not-italic font-bold leading-[normal] tracking-[1.6px]">Welcome to <span className="flex text-[rgb(92,110,141)]">FastCommerce!</span> </p>
            ...
            <form onSubmit={handleFormSubmit} method="POST" className="w-full">
              ...
              <div>
                <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] font-normal leading-[normal] tracking-[0.6px] text-[rgb(92,110,141)]">Name</p>
                ...
                <div>
                <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] font-normal leading-[normal] tracking-[0.6px] text-[rgb(92,110,141)]">Email</p>
                ...
                <div>
                  <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] font-normal leading-[normal] tracking-[0.6px] text-[rgb(92,110,141)]">Photo</p>
                ...
                <div>
                  <p className=" pt-0 pr-2 pb-0 pl-2 mr-0 mb-0 ml-2 not-italic text-[21px] leading-[normal] tracking-[0.6px] text-[rgb(92,110,141)]">Password</p>
                ...
                <button className="w-[70vw] md:w-[30vw] h-12 shrink-0 border rounded-[10px] bg-blue-500 border-solid border-[rgb(92,110,141)] flex justify-center items-center">
                  <img src="/google.png" className="w-10 h-10 shrink-0 bg-white" />
                  <Anchor onClick={alertSoon} className="ms-2 text-[#1F1F1F] text-center text-[21px] not-italic font-medium leading-[normal] tracking-[0.7px]">Sign Up with Google</Anchor>
                </button>
