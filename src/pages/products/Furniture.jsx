...
export default function Furniture() {
  ...
  const uniqueBrands = [...new Set(furnitureProducts?.map((product) => product.brand))]; // Obtener marcas únicas
  const uniqueColors = [...new Set(furnitureProducts?.map((product) => product.description[0]?.color))];
