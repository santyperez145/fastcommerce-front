...
export default function KitchenAndBath() {
  ...
  let kitchenAndBathProducts = filterByCategoryId(products, "64d4fd9fc84ae7805abbeabd")
  const uniqueBrands = [...new Set(kitchenAndBathProducts?.map((product) => product.brand))]; // Obtener marcas únicas
  const uniqueColors = [...new Set(kitchenAndBathProducts?.map((product) => product.description[0]?.color))];
  ...
  let filteredProducts = kitchenAndBathProducts;
  if (selectedBrand) {
  ...
  return (
    ...
    <div className="flex items-center justify-center">
      <div className="flex flex-col mt-6 self-start w-[22.5vw] min-h-[36vh] ">
        <p className="font-bold justify-start text-2xl text-[rgb(42,51,66)] ">Kitchen Products</p>
