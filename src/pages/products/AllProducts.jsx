...
export default function AllProducts() {
  ...
  const uniqueBrands = [...new Set(products?.map((product) => product.brand))]; // Obtener marcas únicas
  const uniqueColors = [...new Set(products?.map((product) => product.description[0]?.color))];
