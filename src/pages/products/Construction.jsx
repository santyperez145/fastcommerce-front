...
export default function Construction() {
  ...
  const uniqueBrands = [...new Set(constructionProducts?.map((product) => product.brand))]; // Obtener marcas únicas
  const uniqueColors = [...new Set(constructionProducts?.map((product) => product.description[0]?.color))];
  ...
  return (
    ...
    <div className="flex items-center justify-center">
      <div className="flex flex-col mt-6 self-start w-[22.5vw] min-h-[36vh] ">
        <p className="font-bold justify-start text-2xl text-[rgb(42,51,66)] ">Construction Products</p>
