...
export default function Hardware() {
  ...
  const uniqueBrands = [...new Set(hardwareProducts?.map((product) => product.brand))]; // Obtener marcas únicas
  const uniqueColors = [...new Set(hardwareProducts?.map((product) => product.description[0]?.color))];
  ...
  let filteredProducts = hardwareProducts;
  if (selectedBrand) {
  ...
  return (
    ...
    <div className="flex items-center justify-center">
      <div className="flex flex-col mt-6 self-start w-[22.5vw] min-h-[36vh] ">
        <p className="font-bold justify-start text-2xl text-[rgb(42,51,66)] ">Hardware Products</p>
